...
\end{align}
der Funktionen, die auf dem \index{Randbedingungen!Dirichlet-Rand} Dirichtlet-Rand $\Gamma_u$ gleich Null sind. Weiter sei analog zur Teilmenge $K \subset H^1_0(\Omega)$ die zu betrachtende Teilmenge von $H^1_{\Gamma_u}(\Omega)$ definiert durch
