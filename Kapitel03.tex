...
\begin{satz}[Äquivalenz zu quadratischem Programm]
...
\item \begin{bem}
Das quadratische Programm \eqref{eq:3.16} hat mit den Voraussetzungen aus Bemerkung \ref{bem:2.17} eine globale Lösung $\bs\mu$, wenn diese die KKT-Bedingungen \eqref{eq:KKT} erfüllt (vgl. Theorem \ref{theorem:B.1}).
\end{bem}
