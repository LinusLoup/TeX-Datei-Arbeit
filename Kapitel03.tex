...
\end{align}
mit $K := \{v \in H^1_0(\Omega) \with v\ge \psi$ fast überall in $\Omega\}$, wobei $a(\cdot,\cdot), (f,\cdot)$ wie in Kapitel \ref{kap:2.2} definiert sind. Das Funktional $J$ gibt hierbei anschaulich wieder die in der Membran gespeicherte Energie an.
...
\[
	J: H \ra \R, J(v) = \frac 1 2 a(v,v) - F(v) \, .
\]
