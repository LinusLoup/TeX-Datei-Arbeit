...
\lstset{language=Matlab,
	...
	deletekeywords={lower,flag,find,abs,max,length,sum,zeros,ones,ceil,size,sqrt,norm,sparse,margin,prod,all,meshgrid,diag,text,num2str,min,legend,axis,full,plot,subplot,title,figure,tic,toc,eps,load,isempty,fprintf,any},
