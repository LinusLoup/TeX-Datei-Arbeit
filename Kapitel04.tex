...
\end{align}
Hierbei ist die Abschätzung der lokalen Anteile $\rho_p(e)$ abhängig von einer Anwendung der Poincaré-Friedrichungleichung (Satz \ref{satz:2.13}), die auf die \textit{\idx{verallgemeinerte Poincaré-Friedrich-Ungleichung}}\index{Ungleichungen!Poincaré} (vgl. auch \cite{Rudin})
