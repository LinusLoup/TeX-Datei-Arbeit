...
\item daher kann jedes Element $v_{\mcal Q} \in \mcal Q_h$ geschrieben werden als $v_{\mcal Q} = v_{\mcal S} + v_{\mcal V}$ mit $v_{\mcal S} \in \mcal S_h, v_{\mcal V}\in \mcal V_h$
\end{itemize}
