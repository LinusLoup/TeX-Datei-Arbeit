...
\item da für die nodalen Basisfunktionen $\{\phi_p \mid p \in \mcal N\cap \Omega\}$ gilt
\[
...
\end{align}
wobei $\mcal N^{0+} \coloneqq \{p \in \mcal N^0 \mid u_{\mcal S} > \psi \text{ in }\omega_p \setminus \{p\}\}$, also die Megne der \textit{isolierten Kontaktknoten}, d.h. $u_{\mcal S}$ ist in $\omega_p$ nur mit $p$ in Kontakt
