...
\item
\begin{satz}\textnormal{(\idx{Poincaré-Friedrich-Ungleichung})}\label{satz:2.6}
...
\]
d.h. $v \in \im A$ und damit ist $\im A$ abgeschlossen. 

(i) Eindeutigkeit: Es seien $A_1,A_2 \in \mcal L(H,H)$ zwei lineare Operatoren mit $A_1u = l$ und $A_2 u = l$. 
\end{proof}
\end{itemize}
