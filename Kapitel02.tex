...
\end{align}
Da $F(\cdot),a(u,\cdot)$ linear sind und alle $v_h \in V_h$ wie in \eqref{eq:2.10} darstellbar sind, ist \eqref{eq:2.9} äquivalent zum Problem
\[
...
Die Idee der Hierarchie bzgl. der Räume wollen wir in Kapitel \ref{kap:4}  auf Variationsprobleme unter Nebenbedingung anwenden, um einen a posteriori Schätzer herzuleiten.
