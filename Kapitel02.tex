...
\item $\Ra$ wir beschränken uns auf das \textit{homogene Dirichlet-Problem}\index{Dirichlet-Problem!homogenes} \eqref{eq:2.2a}, d.h. sei $g\equiv 0$ in \eqref{eq:2.1a}
