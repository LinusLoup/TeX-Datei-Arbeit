...
\begin{figure}[h]
\begin{center}
\subfigure[Test1]{\includegraphics[width=10cm]{Abbildungen/exakte_loesung_hindernisproblem1_Kopie.ps}}
\hfill
\subfigure[Test2]{\includegraphics[width=10cm]{Abbildungen/exakte_loesung_hindernisproblem1.eps}}
\end{center}
\caption{Exakte Lösung des Hindernisproblems}
\end{figure}
\end{bsp}
